...
const DynamicGeneratorPage: React.FC = () => {
  ...
  const handleGenerateTimetables = async () => {
    ...
    try {
      ...
      // Generate 3 different timetable options with different optimization strategies
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <h1 className="text-3xl font-bold text-gray-800">Dynamic Timetable Generator</h1>
        </div>
      ...
      {activeStep === 1 && (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            The system will analyze your current data and create 3 optimized timetable options using different strategies.
            Each option will be evaluated for conflicts, faculty utilization, and room efficiency.
          </p>
            ...
            {generatedOptions.map((option, index) => (
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-600">Faculty Util.</span>
                    <span className="font-medium">{option.facultyUtilization}%</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Room Util.</span>
                ...
                {selectedOption === index && (
                  <div className="mt-4 p-3 bg-blue-50 rounded-lg">
                    <p className="text-sm text-blue-800 font-medium">Selected - Ready for editing and publishing</p>
                  </div>
                )}
              </div>
            ))}
      ...
      {activeStep === 3 && selectedOption !== null && (
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-semibold text-gray-800">Edit & Publish Timetable</h2>
            <div className="flex items-center space-x-3">
              <button
              ...
              >
                ...
                <span>{isEditing ? 'Stop Editing' : 'Edit Timetable'}</span>
              </button>
              <button
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              ...
              <div className="text-center">
                <p className="text-2xl font-bold text-green-600">{analytics?.optimizationScore || 0}%</p>
